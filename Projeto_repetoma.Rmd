...
Atualmente, as tecnologias de sequenciamento de nova geração (do inglês, *Next Generation Sequencing* - NGS; YOUNG; GILLUNG, 2020) configuram como uma importante ferramenta no estudo genômico de plantas, possibilitando evidenciar grande parte do repetoma dos genomas vegetais mesmo com baixa cobertura (0,01 – 0,5x do TG) (GOODWIN et al., 2016; YOUNG; GILLUNG, 2020). O desenvolvimento das técnicas de NGS juntamente com ferramentas de bioinformática dedicadas à anotação de elementos repetitivos tem permitido descrever e identificar detalhadamente várias classes de TEs e DNA repetido em tandem em dados de sequenciamento, vários dos quais estão potencialmente envolvidos nas variações de TG (FOURREAU et al., 2023).
